...
exports.outOfDate = function(current, latest) {
  ...
  return console.log(`
  There is a new version for ${chalk.bold(chalk.green('create-ueno-app'))}
  available ${chalk.bold(chalk.green(latest))}. You are currently using ${chalk.bold(chalk.red(current))}.

  Please run ${chalk.bold(chalk.green(command))}
