...
const init = async (starter, { projectName, bundleId }) => {
...
module.exports = function native(projectName, bundleId) {
  output.info(`🚀 Creating ${chalk.bold(chalk.green(projectName))} using ${chalk.bold('react-native-starter')}...`);

  init('https://github.com/ueno-llc/react-native-starter#master', { projectName, bundleId });
};
